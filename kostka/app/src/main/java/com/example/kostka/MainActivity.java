...
public class MainActivity extends AppCompatActivity { // Definicja klasy MainActivity, dziedziczącej po AppCompatActivity.
    ...
    protected void onCreate(Bundle savedInstanceState) { // Metoda wywoływana podczas tworzenia aktywności.
        ...
        TextView wynikText = findViewById(R.id.textView3); // Inicjalizacja TextView do wyświetlania wyniku losowania.
        TextView wynikGryText = findViewById(R.id.textView5); // Inicjalizacja TextView do wyświetlania wyniku gry.
        ...
        Button resetuj = findViewById(R.id.button); // Inicjalizacja przycisku do resetowania gry.
        ...
        ImageView[] kostki = { // Tworzenie tablicy ImageView do przechowywania odniesień do kostek.
                ...
                findViewById(R.id.kostki)  // Inicjalizacja szóstej kostki.
        };

        int[] sciany = { // Tworzenie tablicy z identyfikatorami zasobów obrazków kostek.
                R.drawable.kostka1, // Identyfikator dla obrazka kostki 1.
                R.drawable.kostka2, // Identyfikator dla obrazka kostki 2.
                R.drawable.kostka3, // Identyfikator dla obrazka kostki 3.
                R.drawable.kostka4, // Identyfikator dla obrazka kostki 4.
                R.drawable.kostka5, // Identyfikator dla obrazka kostki 5.
                R.drawable.kostki  // Identyfikator dla obrazka kostki 6.
        };
